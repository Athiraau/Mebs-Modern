...
{
    public class HRMModuleRepo : IHRMModuleRepo
    {
        private DataContext _context; 
        private readonly DtoWrapper _dto;
        public HRMModuleRepo (DataContext context,DtoWrapper dto)
        {
            _context = context;
            _dto = dto;
        ...
        public async Task<dynamic> GetHRMData(string flag, string pagevalue, string paravalue)
        {
            OracleRefCursor result = null;
            var procedureName = "PROC_MEBS_HRM_GET";
        ...
        public async Task<dynamic> PostHRMData(PostReqDto PostReq)
        {
            OracleRefCursor result = null;
            var procedureName = "PROC_MEBS_HRM_POST";
            var parameters = new OracleDynamicParameters();
